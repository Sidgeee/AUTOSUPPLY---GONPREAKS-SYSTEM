...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2026 at 09:38 PM
...
CREATE TABLE `deliveries` (
  ...
  `delivery_status` enum('Pending','Assigned','En Route','Delivered','Cancelled','Issue') NOT NULL DEFAULT 'Pending',
...
INSERT INTO `deliveries` (`delivery_id`, `sale_id`, `customer_name`, `contact_number`, `delivery_address`, `delivery_status`, `delivered_at`, `driver_name`, `driver_user_id`, `pahinante_name`, `delivery_date`) VALUES
(1, 33, 'Christian Jan Bagac', '09987654321', 'ON MY HOUSE', 'Pending', NULL, NULL, NULL, NULL, '2026-07-26'),
(2, 34, 'Christian Jan Bagac', '233456789', 'asdZFXGCHHJJKK', 'Pending', NULL, NULL, NULL, NULL, '2026-07-26'),
(3, 35, 'Christian Jan Bagac', '1235447', 'asddfhfdsdf', 'Delivered', '2026-07-27 19:31:34', NULL, 8, NULL, '2026-07-28');
...
(6, '26570-61J10', 'SUZUKI APV WITH GASKET', 'TRANSMISSION FILTER', 'BJ AUTOSUPPLY ', NULL, 765.00, 50, '2026-03-15 16:05:04'),
...
(25, 'BV56-19-815', 'BONGO MAZDA RF FORD RANGER 2001-2006', 'TRANSMISSION FILTER', 'BJ AUTOSUPPLY ', NULL, 626.00, 38, '2026-03-20 06:15:59'),
...
(38, '24236933', 'CHEVROLET COLORADO TRAILBLAZER', 'TRANSMISSION FILTER', 'BJ AUTOSUPPLY', NULL, 985.00, 0, '2026-03-20 06:38:04'),
...
INSERT INTO `sales` (`sale_id`, `cashier_name`, `handled_by_user_id`, `total_amount`, `payment_method`, `order_type`, `created_at`, `status`) VALUES
(33, 'System Admin', NULL, 3130.00, 'Cash', 'Personal', '2026-07-26 14:42:00', 'Completed'),
(34, 'System Admin', NULL, 4925.00, 'Bank_Transfer', 'Viber', '2026-07-26 14:45:11', 'Completed'),
(35, 'cj', 5, 7512.00, 'GCash', 'Email', '2026-07-27 16:43:12', 'Completed');
...
INSERT INTO `sale_items` (`sale_item_id`, `sale_id`, `supplier_part_number`, `quantity`, `price`, `subtotal`) VALUES
(1, 33, 'BV56-19-815', 5, 626.00, 3130.00),
(2, 34, '24236933', 5, 985.00, 4925.00),
(3, 35, 'BV56-19-815', 12, 626.00, 7512.00);
...
CREATE TABLE `users` (
  ...
  `driver_status` enum('Off-Duty','Available','In-Transit','On-Site') NOT NULL DEFAULT 'Off-Duty',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`user_id`, `full_name`, `username`, `password`, `role`, `status`, `driver_status`, `created_at`) VALUES
(4, 'System Admin', 'admin', 'admin123', 'Admin', 'Active', 'Off-Duty', '2026-03-13 12:30:08'),
(5, 'cj', 'cashier', '$2y$10$6i9fy20BtDunx33IQ5p1rekqKrpdOVnHx.YHlLdmSBjyZepdcLX26', 'Cashier', 'Active', 'Off-Duty', '2026-07-26 21:19:44'),
(6, 'jc', 'restocker', '$2y$10$Vrn1mq7Dsjampd2DUPNZROYfKHHDG6ffRx9sTsXelRRQQi.ewAv0u', 'Restocker', 'Active', 'Off-Duty', '2026-07-27 16:46:20'),
(7, 'jj', 'manager', '$2y$10$hlmpgqUsbk/shBb6/Kad3utHZWbpPcerT8bTk/M2gb3Gjs3QCzBkK', 'Account Manager', 'Active', 'Off-Duty', '2026-07-27 16:46:36'),
(8, 'cc', 'driver', '$2y$10$Fx/83IpMQa5Jz.WBh8odJuj8jODzxw1Ujj7olvw0my/Iy1kpNhQf2', 'Driver', 'Active', 'Available', '2026-07-27 16:46:48');
